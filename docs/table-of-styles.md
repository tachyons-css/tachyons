...
.aspect-ratio--4x6 | padding-bottom: 150% | aspect-ratios
.aspect-ratio--8x5 | padding-bottom: 62.5% | aspect-ratios
.aspect-ratio--5x8 | padding-bottom: 160% | aspect-ratios
.aspect-ratio--7x5 | padding-bottom: 71.42% | aspect-ratios
.aspect-ratio--5x7 | padding-bottom: 140% | aspect-ratios
.aspect-ratio--1x1 | padding-bottom: 100% | aspect-ratios
.aspect-ratio--object | position: absolute;<br />top: 0;<br />right: 0;<br />bottom: 0;<br />left: 0;<br />width: 100%;<br />height: 100%;<br />z-index: 100 | aspect-ratios
.aspect-ratio-m | height: 0;<br />position: relative | aspect-ratios
.aspect-ratio--16x9-m | padding-bottom: 56.25% | aspect-ratios
.aspect-ratio--9x16-m | padding-bottom: 177.77% | aspect-ratios
.aspect-ratio--4x3-m | padding-bottom: 75% | aspect-ratios
...
.aspect-ratio--1x1-m | padding-bottom: 100% | aspect-ratios
.aspect-ratio--object-m | position: absolute;<br />top: 0;<br />right: 0;<br />bottom: 0;<br />left: 0;<br />width: 100%;<br />height: 100%;<br />z-index: 100 | aspect-ratios
.aspect-ratio-l | height: 0;<br />position: relative | aspect-ratios
...
.aspect-ratio--5x8-l | padding-bottom: 160% | aspect-ratios
.aspect-ratio--7x5-l | padding-bottom: 71.42% | aspect-ratios
...
.bg-center-m | background-repeat: no-repeat;<br />background-position: center center | background-position
...
.b--white-80 | border-color: var(--white-80) | border-colors
.b--white-70 | border-color: var(--white-70) | border-colors
.b--white-60 | border-color: var(--white-60) | border-colors
.b--white-50 | border-color: var(--white-50) | border-colors
.b--white-40 | border-color: var(--white-40) | border-colors
.b--white-30 | border-color: var(--white-30) | border-colors
.b--white-20 | border-color: var(--white-20) | border-colors
.b--white-10 | border-color: var(--white-10) | border-colors
.b--white-05 | border-color: var(--white-05) | border-colors
.b--white-025 | border-color: var(--white-025) | border-colors
.b--white-0125 | border-color: var(--white-0125) | border-colors
.b--black-90 | border-color: var(--black-90) | border-colors
.b--black-80 | border-color: var(--black-80) | border-colors
.b--black-70 | border-color: var(--black-70) | border-colors
.b--black-60 | border-color: var(--black-60) | border-colors
.b--black-50 | border-color: var(--black-50) | border-colors
.b--black-40 | border-color: var(--black-40) | border-colors
...
.br3 | border-radius: .5rem | border-radius
.br4 | border-radius: 1rem | border-radius
.br-100 | border-radius: 100% | border-radius
.br-pill | border-radius: 9999px | border-radius
.br--bottom | border-top-left-radius: 0;<br />border-top-right-radius: 0 | border-radius
.br--top | border-bottom-left-radius: 0;<br />border-bottom-right-radius: 0 | border-radius
.br--right | border-top-left-radius: 0;<br />border-bottom-left-radius: 0 | border-radius
...
.bt-0-ns | border-top-width: 0 | border-widths
.br-0-ns | border-right-width: 0 | border-widths
...
.shadow-4 | box-shadow: 2px 2px 8px 0px rgba( 0, 0, 0, 0.2 ) | box-shadow
.shadow-5 | box-shadow: 4px 4px 8px 0px rgba( 0, 0, 0, 0.2 ) | box-shadow
.shadow-1-m | box-shadow: 0px 0px 4px 2px rgba( 0, 0, 0, 0.2 ) | box-shadow
.shadow-2-m | box-shadow: 0px 0px 8px 2px rgba( 0, 0, 0, 0.2 ) | box-shadow
.shadow-3-m | box-shadow: 2px 2px 4px 2px rgba( 0, 0, 0, 0.2 ) | box-shadow
.shadow-4-m | box-shadow: 2px 2px 8px 0px rgba( 0, 0, 0, 0.2 ) | box-shadow
.shadow-5-m | box-shadow: 4px 4px 8px 0px rgba( 0, 0, 0, 0.2 ) | box-shadow
.shadow-1-l | box-shadow: 0px 0px 4px 2px rgba( 0, 0, 0, 0.2 ) | box-shadow
...
.bottom--2 | bottom: -2rem | coordinates
.left--2 | left: -2rem | coordinates
.absolute--fill | top: 0;<br />right: 0;<br />bottom: 0;<br />left: 0 | coordinates
.top-0-m | top: 0 | coordinates
.left-0-m | left: 0 | coordinates
.right-0-m | right: 0 | coordinates
.bottom-0-m | bottom: 0 | coordinates
.top-1-m | top: 1rem | coordinates
.left-1-m | left: 1rem | coordinates
.right-1-m | right: 1rem | coordinates
.bottom-1-m | bottom: 1rem | coordinates
.top-2-m | top: 2rem | coordinates
.left-2-m | left: 2rem | coordinates
.right-2-m | right: 2rem | coordinates
...
.top-1-l | top: 1rem | coordinates
.left-1-l | left: 1rem | coordinates
.right-1-l | right: 1rem | coordinates
.bottom-1-l | bottom: 1rem | coordinates
.top-2-l | top: 2rem | coordinates
.left-2-l | left: 2rem | coordinates
.right-2-l | right: 2rem | coordinates
...
.dib | display: inline-block | display
.dit | display: inline-table | display
.dt | display: table | display
.dtc | display: table-cell | display
.dt-row | display: table-row | display
.dt-row-group | display: table-row-group | display
.dt-column | display: table-column | display
.dt-column-group | display: table-column-group | display
.dt--fixed | table-layout: fixed;<br />width: 100% | display
.dn-m | display: none | display
...
.flex-column | flex-direction: column | flexbox
.flex-row | flex-direction: row | flexbox
.flex-wrap | flex-wrap: wrap | flexbox
.flex-nowrap | flex-wrap: nowrap | flexbox
.flex-wrap-reverse | flex-wrap: wrap-reverse | flexbox
.flex-column-reverse | flex-direction: column-reverse | flexbox
.flex-row-reverse | flex-direction: row-reverse | flexbox
.items-start | align-items: flex-start | flexbox
.items-end | align-items: flex-end | flexbox
.items-center | align-items: center | flexbox
.items-baseline | align-items: baseline | flexbox
...
.self-baseline | align-self: baseline | flexbox
.self-stretch | align-self: stretch | flexbox
...
.content-start | align-content: flex-start | flexbox
.content-end | align-content: flex-end | flexbox
.content-center | align-content: center | flexbox
.content-between | align-content: space-between | flexbox
.content-around | align-content: space-around | flexbox
.content-stretch | align-content: stretch | flexbox
.order-0 | order: 0 | flexbox
.order-1 | order: 1 | flexbox
.order-2 | order: 2 | flexbox
.order-3 | order: 3 | flexbox
.order-4 | order: 4 | flexbox
.order-5 | order: 5 | flexbox
.order-6 | order: 6 | flexbox
.order-7 | order: 7 | flexbox
.order-8 | order: 8 | flexbox
.order-last | order: 99999 | flexbox
.flex-grow-0 | flex-grow: 0 | flexbox
.flex-grow-1 | flex-grow: 1 | flexbox
.flex-shrink-0 | flex-shrink: 0 | flexbox
.flex-shrink-1 | flex-shrink: 1 | flexbox
.flex-m | display: flex | flexbox
.inline-flex-m | display: inline-flex | flexbox
.flex-auto-m | flex: 1 1 auto;<br />min-width: 0;<br />min-height: 0 | flexbox
.flex-none-m | flex: none | flexbox
.flex-column-m | flex-direction: column | flexbox
.flex-row-m | flex-direction: row | flexbox
.flex-wrap-m | flex-wrap: wrap | flexbox
.flex-nowrap-m | flex-wrap: nowrap | flexbox
.flex-wrap-reverse-m | flex-wrap: wrap-reverse | flexbox
.flex-column-reverse-m | flex-direction: column-reverse | flexbox
...
.self-end-m | align-self: flex-end | flexbox
.self-center-m | align-self: center | flexbox
.self-baseline-m | align-self: baseline | flexbox
.self-stretch-m | align-self: stretch | flexbox
.justify-start-m | justify-content: flex-start | flexbox
.justify-end-m | justify-content: flex-end | flexbox
.justify-center-m | justify-content: center | flexbox
.justify-between-m | justify-content: space-between | flexbox
.justify-around-m | justify-content: space-around | flexbox
.content-start-m | align-content: flex-start | flexbox
.content-end-m | align-content: flex-end | flexbox
.content-center-m | align-content: center | flexbox
.content-between-m | align-content: space-between | flexbox
.content-around-m | align-content: space-around | flexbox
.content-stretch-m | align-content: stretch | flexbox
.order-0-m | order: 0 | flexbox
.order-1-m | order: 1 | flexbox
.order-2-m | order: 2 | flexbox
.order-3-m | order: 3 | flexbox
.order-4-m | order: 4 | flexbox
.order-5-m | order: 5 | flexbox
.order-6-m | order: 6 | flexbox
.order-7-m | order: 7 | flexbox
.order-8-m | order: 8 | flexbox
.order-last-m | order: 99999 | flexbox
.flex-grow-0-m | flex-grow: 0 | flexbox
.flex-grow-1-m | flex-grow: 1 | flexbox
.flex-shrink-0-m | flex-shrink: 0 | flexbox
.flex-shrink-1-m | flex-shrink: 1 | flexbox
.flex-l | display: flex | flexbox
.inline-flex-l | display: inline-flex | flexbox
.flex-auto-l | flex: 1 1 auto;<br />min-width: 0;<br />min-height: 0 | flexbox
.flex-none-l | flex: none | flexbox
.flex-column-l | flex-direction: column | flexbox
.flex-row-l | flex-direction: row | flexbox
.flex-wrap-l | flex-wrap: wrap | flexbox
.flex-nowrap-l | flex-wrap: nowrap | flexbox
.flex-wrap-reverse-l | flex-wrap: wrap-reverse | flexbox
.flex-column-reverse-l | flex-direction: column-reverse | flexbox
.flex-row-reverse-l | flex-direction: row-reverse | flexbox
.items-start-l | align-items: flex-start | flexbox
.items-end-l | align-items: flex-end | flexbox
.items-center-l | align-items: center | flexbox
.items-baseline-l | align-items: baseline | flexbox
.items-stretch-l | align-items: stretch | flexbox
.self-start-l | align-self: flex-start | flexbox
.self-end-l | align-self: flex-end | flexbox
.self-center-l | align-self: center | flexbox
.self-baseline-l | align-self: baseline | flexbox
.self-stretch-l | align-self: stretch | flexbox
.justify-start-l | justify-content: flex-start | flexbox
...
.content-between-l | align-content: space-between | flexbox
.content-around-l | align-content: space-around | flexbox
.content-stretch-l | align-content: stretch | flexbox
.order-0-l | order: 0 | flexbox
...
.fw9 | font-weight: 900 | font-weight
.normal-m | font-weight: normal | font-weight
.b-m | font-weight: bold | font-weight
.fw1-m | font-weight: 100 | font-weight
.fw2-m | font-weight: 200 | font-weight
.fw3-m | font-weight: 300 | font-weight
.fw4-m | font-weight: 400 | font-weight
.fw5-m | font-weight: 500 | font-weight
.fw6-m | font-weight: 600 | font-weight
.fw7-m | font-weight: 700 | font-weight
...
.fw4-l | font-weight: 400 | font-weight
.fw5-l | font-weight: 500 | font-weight
.fw6-l | font-weight: 600 | font-weight
.fw7-l | font-weight: 700 | font-weight
.fw8-l | font-weight: 800 | font-weight
...
.h4 | height: 8rem | heights
.h5 | height: 16rem | heights
.h-25 | height: 25% | heights
.h-50 | height: 50% | heights
.h-75 | height: 75% | heights
.h-100 | height: 100% | heights
.min-h-100 | min-height: 100% | heights
.vh-25 | height: 25vh | heights
.vh-50 | height: 50vh | heights
.vh-75 | height: 75vh | heights
.vh-100 | height: 100vh | heights
.min-vh-100 | min-height: 100vh | heights
.h-auto | height: auto | heights
.h-inherit | height: inherit | heights
.h1-m | height: 1rem | heights
.h2-m | height: 2rem | heights
.h3-m | height: 4rem | heights
.h4-m | height: 8rem | heights
.h5-m | height: 16rem | heights
.h-25-m | height: 25% | heights
.h-50-m | height: 50% | heights
.h-75-m | height: 75% | heights
.h-100-m | height: 100% | heights
.min-h-100-m | min-height: 100% | heights
.vh-25-m | height: 25vh | heights
.vh-50-m | height: 50vh | heights
...
.link:active | transition: color .15s ease-in | links
.link:focus | transition: color .15s ease-in;<br />outline: 1px dotted currentColor | links
.list | list-style-type: none | lists
.mw-100 | max-width: 100% | max-widths
...
.mw8 | max-width: 64rem | max-widths
.mw9 | max-width: 96rem | max-widths
.mw-none | max-width: none | max-widths
.mw-100-m | max-width: 100% | max-widths
.mw1-m | max-width: 1rem | max-widths
.mw2-m | max-width: 2rem | max-widths
.mw3-m | max-width: 4rem | max-widths
.mw4-m | max-width: 8rem | max-widths
.mw5-m | max-width: 16rem | max-widths
.mw6-m | max-width: 32rem | max-widths
.mw7-m | max-width: 48rem | max-widths
.mw8-m | max-width: 64rem | max-widths
.mw9-m | max-width: 96rem | max-widths
.mw-none-m | max-width: none | max-widths
.mw-100-l | max-width: 100% | max-widths
.mw1-l | max-width: 1rem | max-widths
.mw2-l | max-width: 2rem | max-widths
.mw3-l | max-width: 4rem | max-widths
.mw4-l | max-width: 8rem | max-widths
.mw5-l | max-width: 16rem | max-widths
.mw6-l | max-width: 32rem | max-widths
...
.overflow-y-auto-m | overflow-y: auto | overflow
.overflow-visible-l | overflow: visible | overflow
.overflow-hidden-l | overflow: hidden | overflow
.overflow-scroll-l | overflow: scroll | overflow
.overflow-auto-l | overflow: auto | overflow
.overflow-x-visible-l | overflow-x: visible | overflow
.overflow-x-hidden-l | overflow-x: hidden | overflow
.overflow-x-scroll-l | overflow-x: scroll | overflow
.overflow-x-auto-l | overflow-x: auto | overflow
.overflow-y-visible-l | overflow-y: visible | overflow
...
.static-l | position: static | position
...
.rotate-270 | transform: rotate(270deg) | rotations
.rotate-315 | transform: rotate(315deg) | rotations
.rotate-45-m | transform: rotate(45deg) | rotations
.rotate-90-m | transform: rotate(90deg) | rotations
.rotate-135-m | transform: rotate(135deg) | rotations
.rotate-180-m | transform: rotate(180deg) | rotations
.rotate-225-m | transform: rotate(225deg) | rotations
.rotate-270-m | transform: rotate(270deg) | rotations
.rotate-315-m | transform: rotate(315deg) | rotations
.rotate-45-l | transform: rotate(45deg) | rotations
.rotate-90-l | transform: rotate(90deg) | rotations
.rotate-135-l | transform: rotate(135deg) | rotations
...
.hover-bg-near-white:hover,<br />.hover-bg-near-white:focus | background-color: var(--near-white) | skins-pseudo
.hover-bg-white:hover,<br />.hover-bg-white:focus | background-color: var(--white) | skins-pseudo
.hover-bg-transparent:hover,<br />.hover-bg-transparent:focus | background-color: var(--transparent) | skins-pseudo
.hover-bg-black-90:hover,<br />.hover-bg-black-90:focus | background-color: var(--black-90) | skins-pseudo
.hover-bg-black-80:hover,<br />.hover-bg-black-80:focus | background-color: var(--black-80) | skins-pseudo
.hover-bg-black-70:hover,<br />.hover-bg-black-70:focus | background-color: var(--black-70) | skins-pseudo
.hover-bg-black-60:hover,<br />.hover-bg-black-60:focus | background-color: var(--black-60) | skins-pseudo
.hover-bg-black-50:hover,<br />.hover-bg-black-50:focus | background-color: var(--black-50) | skins-pseudo
.hover-bg-black-40:hover,<br />.hover-bg-black-40:focus | background-color: var(--black-40) | skins-pseudo
.hover-bg-black-30:hover,<br />.hover-bg-black-30:focus | background-color: var(--black-30) | skins-pseudo
.hover-bg-black-20:hover,<br />.hover-bg-black-20:focus | background-color: var(--black-20) | skins-pseudo
.hover-bg-black-10:hover,<br />.hover-bg-black-10:focus | background-color: var(--black-10) | skins-pseudo
...
.hover-bg-white-20:hover,<br />.hover-bg-white-20:focus | background-color: var(--white-20) | skins-pseudo
.hover-bg-white-10:hover,<br />.hover-bg-white-10:focus | background-color: var(--white-10) | skins-pseudo
.hover-dark-red:hover,<br />.hover-dark-red:focus | color: var(--dark-red) | skins-pseudo
.hover-red:hover,<br />.hover-red:focus | color: var(--red) | skins-pseudo
.hover-light-red:hover,<br />.hover-light-red:focus | color: var(--light-red) | skins-pseudo
.hover-orange:hover,<br />.hover-orange:focus | color: var(--orange) | skins-pseudo
.hover-gold:hover,<br />.hover-gold:focus | color: var(--gold) | skins-pseudo
.hover-yellow:hover,<br />.hover-yellow:focus | color: var(--yellow) | skins-pseudo
.hover-light-yellow:hover,<br />.hover-light-yellow:focus | color: var(--light-yellow) | skins-pseudo
.hover-purple:hover,<br />.hover-purple:focus | color: var(--purple) | skins-pseudo
.hover-light-purple:hover,<br />.hover-light-purple:focus | color: var(--light-purple) | skins-pseudo
.hover-dark-pink:hover,<br />.hover-dark-pink:focus | color: var(--dark-pink) | skins-pseudo
.hover-hot-pink:hover,<br />.hover-hot-pink:focus | color: var(--hot-pink) | skins-pseudo
...
.hover-blue:hover,<br />.hover-blue:focus | color: var(--blue) | skins-pseudo
.hover-light-blue:hover,<br />.hover-light-blue:focus | color: var(--light-blue) | skins-pseudo
.hover-lightest-blue:hover,<br />.hover-lightest-blue:focus | color: var(--lightest-blue) | skins-pseudo
.hover-washed-blue:hover,<br />.hover-washed-blue:focus | color: var(--washed-blue) | skins-pseudo
.hover-washed-green:hover,<br />.hover-washed-green:focus | color: var(--washed-green) | skins-pseudo
.hover-washed-yellow:hover,<br />.hover-washed-yellow:focus | color: var(--washed-yellow) | skins-pseudo
.hover-washed-red:hover,<br />.hover-washed-red:focus | color: var(--washed-red) | skins-pseudo
.hover-bg-dark-red:hover,<br />.hover-bg-dark-red:focus | background-color: var(--dark-red) | skins-pseudo
.hover-bg-red:hover,<br />.hover-bg-red:focus | background-color: var(--red) | skins-pseudo
.hover-bg-light-red:hover,<br />.hover-bg-light-red:focus | background-color: var(--light-red) | skins-pseudo
.hover-bg-orange:hover,<br />.hover-bg-orange:focus | background-color: var(--orange) | skins-pseudo
.hover-bg-gold:hover,<br />.hover-bg-gold:focus | background-color: var(--gold) | skins-pseudo
.hover-bg-yellow:hover,<br />.hover-bg-yellow:focus | background-color: var(--yellow) | skins-pseudo
.hover-bg-light-yellow:hover,<br />.hover-bg-light-yellow:focus | background-color: var(--light-yellow) | skins-pseudo
.hover-bg-purple:hover,<br />.hover-bg-purple:focus | background-color: var(--purple) | skins-pseudo
.hover-bg-light-purple:hover,<br />.hover-bg-light-purple:focus | background-color: var(--light-purple) | skins-pseudo
.hover-bg-dark-pink:hover,<br />.hover-bg-dark-pink:focus | background-color: var(--dark-pink) | skins-pseudo
.hover-bg-hot-pink:hover,<br />.hover-bg-hot-pink:focus | background-color: var(--hot-pink) | skins-pseudo
.hover-bg-pink:hover,<br />.hover-bg-pink:focus | background-color: var(--pink) | skins-pseudo
.hover-bg-light-pink:hover,<br />.hover-bg-light-pink:focus | background-color: var(--light-pink) | skins-pseudo
.hover-bg-dark-green:hover,<br />.hover-bg-dark-green:focus | background-color: var(--dark-green) | skins-pseudo
.hover-bg-green:hover,<br />.hover-bg-green:focus | background-color: var(--green) | skins-pseudo
.hover-bg-light-green:hover,<br />.hover-bg-light-green:focus | background-color: var(--light-green) | skins-pseudo
.hover-bg-navy:hover,<br />.hover-bg-navy:focus | background-color: var(--navy) | skins-pseudo
.hover-bg-dark-blue:hover,<br />.hover-bg-dark-blue:focus | background-color: var(--dark-blue) | skins-pseudo
.hover-bg-blue:hover,<br />.hover-bg-blue:focus | background-color: var(--blue) | skins-pseudo
.hover-bg-light-blue:hover,<br />.hover-bg-light-blue:focus | background-color: var(--light-blue) | skins-pseudo
.hover-bg-lightest-blue:hover,<br />.hover-bg-lightest-blue:focus | background-color: var(--lightest-blue) | skins-pseudo
.hover-bg-washed-blue:hover,<br />.hover-bg-washed-blue:focus | background-color: var(--washed-blue) | skins-pseudo
.hover-bg-washed-green:hover,<br />.hover-bg-washed-green:focus | background-color: var(--washed-green) | skins-pseudo
...
.mr4 | margin-right: var(--spacing-large) | spacing
.mr5 | margin-right: var(--spacing-extra-large) | spacing
.mr6 | margin-right: var(--spacing-extra-extra-large) | spacing
.mr7 | margin-right: var(--spacing-extra-extra-extra-large) | spacing
.mb0 | margin-bottom: var(--spacing-none) | spacing
.mb1 | margin-bottom: var(--spacing-extra-small) | spacing
.mb2 | margin-bottom: var(--spacing-small) | spacing
.mb3 | margin-bottom: var(--spacing-medium) | spacing
.mb4 | margin-bottom: var(--spacing-large) | spacing
.mb5 | margin-bottom: var(--spacing-extra-large) | spacing
.mb6 | margin-bottom: var(--spacing-extra-extra-large) | spacing
.mb7 | margin-bottom: var(--spacing-extra-extra-extra-large) | spacing
.mt0 | margin-top: var(--spacing-none) | spacing
.mt1 | margin-top: var(--spacing-extra-small) | spacing
.mt2 | margin-top: var(--spacing-small) | spacing
.mt3 | margin-top: var(--spacing-medium) | spacing
.mt4 | margin-top: var(--spacing-large) | spacing
.mt5 | margin-top: var(--spacing-extra-large) | spacing
.mt6 | margin-top: var(--spacing-extra-extra-large) | spacing
.mt7 | margin-top: var(--spacing-extra-extra-extra-large) | spacing
.mv0 | margin-top: var(--spacing-none);<br />margin-bottom: var(--spacing-none) | spacing
.mv1 | margin-top: var(--spacing-extra-small);<br />margin-bottom: var(--spacing-extra-small) | spacing
.mv2 | margin-top: var(--spacing-small);<br />margin-bottom: var(--spacing-small) | spacing
.mv3 | margin-top: var(--spacing-medium);<br />margin-bottom: var(--spacing-medium) | spacing
.mv4 | margin-top: var(--spacing-large);<br />margin-bottom: var(--spacing-large) | spacing
.mv5 | margin-top: var(--spacing-extra-large);<br />margin-bottom: var(--spacing-extra-large) | spacing
.mv6 | margin-top: var(--spacing-extra-extra-large);<br />margin-bottom: var(--spacing-extra-extra-large) | spacing
.mv7 | margin-top: var(--spacing-extra-extra-extra-large);<br />margin-bottom: var(--spacing-extra-extra-extra-large) | spacing
.mh0 | margin-left: var(--spacing-none);<br />margin-right: var(--spacing-none) | spacing
.mh1 | margin-left: var(--spacing-extra-small);<br />margin-right: var(--spacing-extra-small) | spacing
.mh2 | margin-left: var(--spacing-small);<br />margin-right: var(--spacing-small) | spacing
.mh3 | margin-left: var(--spacing-medium);<br />margin-right: var(--spacing-medium) | spacing
.mh4 | margin-left: var(--spacing-large);<br />margin-right: var(--spacing-large) | spacing
.mh5 | margin-left: var(--spacing-extra-large);<br />margin-right: var(--spacing-extra-large) | spacing
.mh6 | margin-left: var(--spacing-extra-extra-large);<br />margin-right: var(--spacing-extra-extra-large) | spacing
.mh7 | margin-left: var(--spacing-extra-extra-extra-large);<br />margin-right: var(--spacing-extra-extra-extra-large) | spacing
.pa0-m | padding: var(--spacing-none) | spacing
.pa1-m | padding: var(--spacing-extra-small) | spacing
.pa2-m | padding: var(--spacing-small) | spacing
.pa3-m | padding: var(--spacing-medium) | spacing
.pa4-m | padding: var(--spacing-large) | spacing
.pa5-m | padding: var(--spacing-extra-large) | spacing
.pa6-m | padding: var(--spacing-extra-extra-large) | spacing
.pa7-m | padding: var(--spacing-extra-extra-extra-large) | spacing
.pl0-m | padding-left: var(--spacing-none) | spacing
.pl1-m | padding-left: var(--spacing-extra-small) | spacing
.pl2-m | padding-left: var(--spacing-small) | spacing
.pl3-m | padding-left: var(--spacing-medium) | spacing
.pl4-m | padding-left: var(--spacing-large) | spacing
.pl5-m | padding-left: var(--spacing-extra-large) | spacing
.pl6-m | padding-left: var(--spacing-extra-extra-large) | spacing
.pl7-m | padding-left: var(--spacing-extra-extra-extra-large) | spacing
.pr0-m | padding-right: var(--spacing-none) | spacing
.pr1-m | padding-right: var(--spacing-extra-small) | spacing
.pr2-m | padding-right: var(--spacing-small) | spacing
.pr3-m | padding-right: var(--spacing-medium) | spacing
.pr4-m | padding-right: var(--spacing-large) | spacing
.pr5-m | padding-right: var(--spacing-extra-large) | spacing
.pr6-m | padding-right: var(--spacing-extra-extra-large) | spacing
.pr7-m | padding-right: var(--spacing-extra-extra-extra-large) | spacing
.pb0-m | padding-bottom: var(--spacing-none) | spacing
.pb1-m | padding-bottom: var(--spacing-extra-small) | spacing
.pb2-m | padding-bottom: var(--spacing-small) | spacing
.pb3-m | padding-bottom: var(--spacing-medium) | spacing
.pb4-m | padding-bottom: var(--spacing-large) | spacing
.pb5-m | padding-bottom: var(--spacing-extra-large) | spacing
.pb6-m | padding-bottom: var(--spacing-extra-extra-large) | spacing
.pb7-m | padding-bottom: var(--spacing-extra-extra-extra-large) | spacing
.pt0-m | padding-top: var(--spacing-none) | spacing
.pt1-m | padding-top: var(--spacing-extra-small) | spacing
.pt2-m | padding-top: var(--spacing-small) | spacing
.pt3-m | padding-top: var(--spacing-medium) | spacing
.pt4-m | padding-top: var(--spacing-large) | spacing
.pt5-m | padding-top: var(--spacing-extra-large) | spacing
.pt6-m | padding-top: var(--spacing-extra-extra-large) | spacing
.pt7-m | padding-top: var(--spacing-extra-extra-extra-large) | spacing
.pv0-m | padding-top: var(--spacing-none);<br />padding-bottom: var(--spacing-none) | spacing
.pv1-m | padding-top: var(--spacing-extra-small);<br />padding-bottom: var(--spacing-extra-small) | spacing
.pv2-m | padding-top: var(--spacing-small);<br />padding-bottom: var(--spacing-small) | spacing
.pv3-m | padding-top: var(--spacing-medium);<br />padding-bottom: var(--spacing-medium) | spacing
.pv4-m | padding-top: var(--spacing-large);<br />padding-bottom: var(--spacing-large) | spacing
.pv5-m | padding-top: var(--spacing-extra-large);<br />padding-bottom: var(--spacing-extra-large) | spacing
.pv6-m | padding-top: var(--spacing-extra-extra-large);<br />padding-bottom: var(--spacing-extra-extra-large) | spacing
.pv7-m | padding-top: var(--spacing-extra-extra-extra-large);<br />padding-bottom: var(--spacing-extra-extra-extra-large) | spacing
.ph0-m | padding-left: var(--spacing-none);<br />padding-right: var(--spacing-none) | spacing
.ph1-m | padding-left: var(--spacing-extra-small);<br />padding-right: var(--spacing-extra-small) | spacing
.ph2-m | padding-left: var(--spacing-small);<br />padding-right: var(--spacing-small) | spacing
.ph3-m | padding-left: var(--spacing-medium);<br />padding-right: var(--spacing-medium) | spacing
.ph4-m | padding-left: var(--spacing-large);<br />padding-right: var(--spacing-large) | spacing
.ph5-m | padding-left: var(--spacing-extra-large);<br />padding-right: var(--spacing-extra-large) | spacing
.ph6-m | padding-left: var(--spacing-extra-extra-large);<br />padding-right: var(--spacing-extra-extra-large) | spacing
.ph7-m | padding-left: var(--spacing-extra-extra-extra-large);<br />padding-right: var(--spacing-extra-extra-extra-large) | spacing
.ma0-m | margin: var(--spacing-none) | spacing
.ma1-m | margin: var(--spacing-extra-small) | spacing
.ma2-m | margin: var(--spacing-small) | spacing
.ma3-m | margin: var(--spacing-medium) | spacing
.ma4-m | margin: var(--spacing-large) | spacing
.ma5-m | margin: var(--spacing-extra-large) | spacing
.ma6-m | margin: var(--spacing-extra-extra-large) | spacing
.ma7-m | margin: var(--spacing-extra-extra-extra-large) | spacing
.ml0-m | margin-left: var(--spacing-none) | spacing
.ml1-m | margin-left: var(--spacing-extra-small) | spacing
.ml2-m | margin-left: var(--spacing-small) | spacing
.ml3-m | margin-left: var(--spacing-medium) | spacing
.ml4-m | margin-left: var(--spacing-large) | spacing
.ml5-m | margin-left: var(--spacing-extra-large) | spacing
.ml6-m | margin-left: var(--spacing-extra-extra-large) | spacing
.ml7-m | margin-left: var(--spacing-extra-extra-extra-large) | spacing
.mr0-m | margin-right: var(--spacing-none) | spacing
.mr1-m | margin-right: var(--spacing-extra-small) | spacing
.mr2-m | margin-right: var(--spacing-small) | spacing
.mr3-m | margin-right: var(--spacing-medium) | spacing
.mr4-m | margin-right: var(--spacing-large) | spacing
.mr5-m | margin-right: var(--spacing-extra-large) | spacing
.mr6-m | margin-right: var(--spacing-extra-extra-large) | spacing
.mr7-m | margin-right: var(--spacing-extra-extra-extra-large) | spacing
.mb0-m | margin-bottom: var(--spacing-none) | spacing
.mb1-m | margin-bottom: var(--spacing-extra-small) | spacing
.mb2-m | margin-bottom: var(--spacing-small) | spacing
.mb3-m | margin-bottom: var(--spacing-medium) | spacing
.mb4-m | margin-bottom: var(--spacing-large) | spacing
.mb5-m | margin-bottom: var(--spacing-extra-large) | spacing
.mb6-m | margin-bottom: var(--spacing-extra-extra-large) | spacing
.mb7-m | margin-bottom: var(--spacing-extra-extra-extra-large) | spacing
.mt0-m | margin-top: var(--spacing-none) | spacing
.mt1-m | margin-top: var(--spacing-extra-small) | spacing
.mt2-m | margin-top: var(--spacing-small) | spacing
.mt3-m | margin-top: var(--spacing-medium) | spacing
.mt4-m | margin-top: var(--spacing-large) | spacing
.mt5-m | margin-top: var(--spacing-extra-large) | spacing
...
.mv5-m | margin-top: var(--spacing-extra-large);<br />margin-bottom: var(--spacing-extra-large) | spacing
.mv6-m | margin-top: var(--spacing-extra-extra-large);<br />margin-bottom: var(--spacing-extra-extra-large) | spacing
.mv7-m | margin-top: var(--spacing-extra-extra-extra-large);<br />margin-bottom: var(--spacing-extra-extra-extra-large) | spacing
.mh0-m | margin-left: var(--spacing-none);<br />margin-right: var(--spacing-none) | spacing
.mh1-m | margin-left: var(--spacing-extra-small);<br />margin-right: var(--spacing-extra-small) | spacing
.mh2-m | margin-left: var(--spacing-small);<br />margin-right: var(--spacing-small) | spacing
.mh3-m | margin-left: var(--spacing-medium);<br />margin-right: var(--spacing-medium) | spacing
.mh4-m | margin-left: var(--spacing-large);<br />margin-right: var(--spacing-large) | spacing
.mh5-m | margin-left: var(--spacing-extra-large);<br />margin-right: var(--spacing-extra-large) | spacing
.mh6-m | margin-left: var(--spacing-extra-extra-large);<br />margin-right: var(--spacing-extra-extra-large) | spacing
.mh7-m | margin-left: var(--spacing-extra-extra-extra-large);<br />margin-right: var(--spacing-extra-extra-extra-large) | spacing
.pa0-l | padding: var(--spacing-none) | spacing
.pa1-l | padding: var(--spacing-extra-small) | spacing
.pa2-l | padding: var(--spacing-small) | spacing
.pa3-l | padding: var(--spacing-medium) | spacing
.pa4-l | padding: var(--spacing-large) | spacing
.pa5-l | padding: var(--spacing-extra-large) | spacing
.pa6-l | padding: var(--spacing-extra-extra-large) | spacing
.pa7-l | padding: var(--spacing-extra-extra-extra-large) | spacing
.pl0-l | padding-left: var(--spacing-none) | spacing
.pl1-l | padding-left: var(--spacing-extra-small) | spacing
.pl2-l | padding-left: var(--spacing-small) | spacing
.pl3-l | padding-left: var(--spacing-medium) | spacing
.pl4-l | padding-left: var(--spacing-large) | spacing
.pl5-l | padding-left: var(--spacing-extra-large) | spacing
.pl6-l | padding-left: var(--spacing-extra-extra-large) | spacing
.pl7-l | padding-left: var(--spacing-extra-extra-extra-large) | spacing
.pr0-l | padding-right: var(--spacing-none) | spacing
.pr1-l | padding-right: var(--spacing-extra-small) | spacing
.pr2-l | padding-right: var(--spacing-small) | spacing
.pr3-l | padding-right: var(--spacing-medium) | spacing
.pr4-l | padding-right: var(--spacing-large) | spacing
.pr5-l | padding-right: var(--spacing-extra-large) | spacing
.pr6-l | padding-right: var(--spacing-extra-extra-large) | spacing
.pr7-l | padding-right: var(--spacing-extra-extra-extra-large) | spacing
.pb0-l | padding-bottom: var(--spacing-none) | spacing
.pb1-l | padding-bottom: var(--spacing-extra-small) | spacing
.pb2-l | padding-bottom: var(--spacing-small) | spacing
.pb3-l | padding-bottom: var(--spacing-medium) | spacing
.pb4-l | padding-bottom: var(--spacing-large) | spacing
.pb5-l | padding-bottom: var(--spacing-extra-large) | spacing
.pb6-l | padding-bottom: var(--spacing-extra-extra-large) | spacing
.pb7-l | padding-bottom: var(--spacing-extra-extra-extra-large) | spacing
.pt0-l | padding-top: var(--spacing-none) | spacing
.pt1-l | padding-top: var(--spacing-extra-small) | spacing
.pt2-l | padding-top: var(--spacing-small) | spacing
.pt3-l | padding-top: var(--spacing-medium) | spacing
.pt4-l | padding-top: var(--spacing-large) | spacing
.pt5-l | padding-top: var(--spacing-extra-large) | spacing
.pt6-l | padding-top: var(--spacing-extra-extra-large) | spacing
.pt7-l | padding-top: var(--spacing-extra-extra-extra-large) | spacing
.pv0-l | padding-top: var(--spacing-none);<br />padding-bottom: var(--spacing-none) | spacing
.pv1-l | padding-top: var(--spacing-extra-small);<br />padding-bottom: var(--spacing-extra-small) | spacing
.pv2-l | padding-top: var(--spacing-small);<br />padding-bottom: var(--spacing-small) | spacing
.pv3-l | padding-top: var(--spacing-medium);<br />padding-bottom: var(--spacing-medium) | spacing
.pv4-l | padding-top: var(--spacing-large);<br />padding-bottom: var(--spacing-large) | spacing
.pv5-l | padding-top: var(--spacing-extra-large);<br />padding-bottom: var(--spacing-extra-large) | spacing
.pv6-l | padding-top: var(--spacing-extra-extra-large);<br />padding-bottom: var(--spacing-extra-extra-large) | spacing
.pv7-l | padding-top: var(--spacing-extra-extra-extra-large);<br />padding-bottom: var(--spacing-extra-extra-extra-large) | spacing
.ph0-l | padding-left: var(--spacing-none);<br />padding-right: var(--spacing-none) | spacing
.ph1-l | padding-left: var(--spacing-extra-small);<br />padding-right: var(--spacing-extra-small) | spacing
.ph2-l | padding-left: var(--spacing-small);<br />padding-right: var(--spacing-small) | spacing
.ph3-l | padding-left: var(--spacing-medium);<br />padding-right: var(--spacing-medium) | spacing
.ph4-l | padding-left: var(--spacing-large);<br />padding-right: var(--spacing-large) | spacing
.ph5-l | padding-left: var(--spacing-extra-large);<br />padding-right: var(--spacing-extra-large) | spacing
.ph6-l | padding-left: var(--spacing-extra-extra-large);<br />padding-right: var(--spacing-extra-extra-large) | spacing
.ph7-l | padding-left: var(--spacing-extra-extra-extra-large);<br />padding-right: var(--spacing-extra-extra-extra-large) | spacing
.ma0-l | margin: var(--spacing-none) | spacing
.ma1-l | margin: var(--spacing-extra-small) | spacing
.ma2-l | margin: var(--spacing-small) | spacing
.ma3-l | margin: var(--spacing-medium) | spacing
.ma4-l | margin: var(--spacing-large) | spacing
.ma5-l | margin: var(--spacing-extra-large) | spacing
.ma6-l | margin: var(--spacing-extra-extra-large) | spacing
.ma7-l | margin: var(--spacing-extra-extra-extra-large) | spacing
.ml0-l | margin-left: var(--spacing-none) | spacing
.ml1-l | margin-left: var(--spacing-extra-small) | spacing
.ml2-l | margin-left: var(--spacing-small) | spacing
.ml3-l | margin-left: var(--spacing-medium) | spacing
.ml4-l | margin-left: var(--spacing-large) | spacing
.ml5-l | margin-left: var(--spacing-extra-large) | spacing
.ml6-l | margin-left: var(--spacing-extra-extra-large) | spacing
.ml7-l | margin-left: var(--spacing-extra-extra-extra-large) | spacing
.mr0-l | margin-right: var(--spacing-none) | spacing
.mr1-l | margin-right: var(--spacing-extra-small) | spacing
.mr2-l | margin-right: var(--spacing-small) | spacing
.mr3-l | margin-right: var(--spacing-medium) | spacing
.mr4-l | margin-right: var(--spacing-large) | spacing
.mr5-l | margin-right: var(--spacing-extra-large) | spacing
.mr6-l | margin-right: var(--spacing-extra-extra-large) | spacing
.mr7-l | margin-right: var(--spacing-extra-extra-extra-large) | spacing
.mb0-l | margin-bottom: var(--spacing-none) | spacing
.mb1-l | margin-bottom: var(--spacing-extra-small) | spacing
.mb2-l | margin-bottom: var(--spacing-small) | spacing
.mb3-l | margin-bottom: var(--spacing-medium) | spacing
.mb4-l | margin-bottom: var(--spacing-large) | spacing
.mb5-l | margin-bottom: var(--spacing-extra-large) | spacing
.mb6-l | margin-bottom: var(--spacing-extra-extra-large) | spacing
.mb7-l | margin-bottom: var(--spacing-extra-extra-extra-large) | spacing
.mt0-l | margin-top: var(--spacing-none) | spacing
.mt1-l | margin-top: var(--spacing-extra-small) | spacing
.mt2-l | margin-top: var(--spacing-small) | spacing
.mt3-l | margin-top: var(--spacing-medium) | spacing
.mt4-l | margin-top: var(--spacing-large) | spacing
.mt5-l | margin-top: var(--spacing-extra-large) | spacing
.mt6-l | margin-top: var(--spacing-extra-extra-large) | spacing
.mt7-l | margin-top: var(--spacing-extra-extra-extra-large) | spacing
.mv0-l | margin-top: var(--spacing-none);<br />margin-bottom: var(--spacing-none) | spacing
.mv1-l | margin-top: var(--spacing-extra-small);<br />margin-bottom: var(--spacing-extra-small) | spacing
.mv2-l | margin-top: var(--spacing-small);<br />margin-bottom: var(--spacing-small) | spacing
.mv3-l | margin-top: var(--spacing-medium);<br />margin-bottom: var(--spacing-medium) | spacing
.mv4-l | margin-top: var(--spacing-large);<br />margin-bottom: var(--spacing-large) | spacing
.mv5-l | margin-top: var(--spacing-extra-large);<br />margin-bottom: var(--spacing-extra-large) | spacing
.mv6-l | margin-top: var(--spacing-extra-extra-large);<br />margin-bottom: var(--spacing-extra-extra-large) | spacing
.mv7-l | margin-top: var(--spacing-extra-extra-extra-large);<br />margin-bottom: var(--spacing-extra-extra-extra-large) | spacing
.mh0-l | margin-left: var(--spacing-none);<br />margin-right: var(--spacing-none) | spacing
.mh1-l | margin-left: var(--spacing-extra-small);<br />margin-right: var(--spacing-extra-small) | spacing
.mh2-l | margin-left: var(--spacing-small);<br />margin-right: var(--spacing-small) | spacing
.mh3-l | margin-left: var(--spacing-medium);<br />margin-right: var(--spacing-medium) | spacing
.mh4-l | margin-left: var(--spacing-large);<br />margin-right: var(--spacing-large) | spacing
...
.strike-m | text-decoration: line-through | text-decoration
...
.measure-m | max-width: 30em | typography
...
.center-m | margin-right: auto;<br />margin-left: auto | utilities
.mr-auto-m | margin-right: auto | utilities
.ml-auto-m | margin-left: auto | utilities
...
.debug-grid | background: transparent url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAICAYAAADED76LAAAAFElEQVR4AWPAC97/9x0eCsAEPgwAVLshdpENIxcAAAAASUVORK5CYII=) repeat top left | debug-grid
.debug-grid-16 | background: transparent url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAMklEQVR4AWOgCLz/b0epAa6UGuBOqQHOQHLUgFEDnAbcBZ4UGwDOkiCnkIhdgNgNxAYAiYlD+8sEuo8AAAAASUVORK5CYII=) repeat top left | debug-grid
.debug-grid-8-solid | background: white url(data:image/gif;base64,R0lGODdhCAAIAPEAAADw/wDx/////wAAACwAAAAACAAIAAACDZQvgaeb/lxbAIKA8y0AOw==) repeat top left | debug-grid
.debug-grid-16-solid | background: white url(data:image/gif;base64,R0lGODdhEAAQAPEAAADw/wDx/xXy/////ywAAAAAEAAQAAACIZyPKckYDQFsb6ZqD85jZ2+BkwiRFKehhqQCQgDHcgwEBQA7) repeat top left | debug-grid